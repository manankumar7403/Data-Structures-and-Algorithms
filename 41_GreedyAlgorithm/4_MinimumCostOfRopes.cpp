// 🔴🔴🔴🔴 GFG 🔴🔴🔴🔴
// ⭐⭐Did the same in 31 Heaps -> Class 4 -> 5. MinimumCostOfRopes.cpp⭐⭐
/*
...
Your Task:
You don't need to read input or print anything. Your task is to complete the function minCost() which takes an integer
array arr[] and an integer n as arguments and returns the minimum cost.
...
int main()
{
    ...
    cout << "Minimum cost to connect the ropes: " << result;
    cout << endl;
    return 0;
}
...
// Similar logic as 2_reOrganize String (in this folder only) -> Heap Method