...
public:
    ...
    bool push(int X, int m)   // m is the mth stack jisme push karna hai ya pop karna hai
    {
        if(freeSpot == -1)
        {
            return false;  // because of stack overflow
        }
...
// TC -> PUSH AND POP -> AMORTIZED: O(1)
// SC -> O(n+size) (no. of stacks and main array)