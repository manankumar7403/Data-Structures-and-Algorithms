...
void printBottomView(Node* root)
{
    ...
    while(!q.empty())
    {
        ...
        // if(topNode.find(hd) == topNode.end()) // ye 'already exist nhi karta hai toh dalenge' wali condition hata di kyuki hum baar baar replace kar denge har HD ke liye usse bottom view aa jayega
        // create entry
