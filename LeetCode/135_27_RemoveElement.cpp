...
// remove put the value to be deleted at the end of the array
// erase removes that element from the end of the array
// thats how these 2(remove and erase) work together
...
int main()
{
    ...
    cin >> val;
    cout << "Size of array after removing " << val << " is " << removeElement(nums, val);
    return 0;
}
