...
// Refer 17_DnC_Assignments -> 3_HomeWork -> 1_merge_2SortedArrConstSpace
/*
...
int main() {
    ...
    cout << "Enter elements for nums1 in ascending order:" << endl;
    for (int i = 0; i < m; ++i) {
        cin >> nums1[i];
    }
    ...
    cout << "Enter elements for nums2 in ascending order:" << endl;
    for (int i = 0; i < n; ++i) {
        cin >> nums2[i];
    }
